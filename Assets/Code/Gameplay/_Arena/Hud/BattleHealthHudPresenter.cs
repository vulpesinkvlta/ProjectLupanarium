...
namespace Code.Gameplay
{
    public sealed class BattleHealthHudPresenter : IStartable, ITickable, IDisposable
    {
        ...
        private readonly Dictionary<int, UnitHealthSegmentView>
            _segmentsByUnitId =
        ...
        {
            IReadOnlyList<UnitRuntime> allUnits =
                _context.AllUnits;
                 ...
                 i++)
            {
                ...
                if (!_segmentsByUnitId.TryGetValue(
                        unit.Id,
                        out UnitHealthSegmentView segment))
                {
                    continue;
                }
